-- INSTALL. Idempotent and limited to two new registrations-schema tables.
-- Canonical migration: supabase/migrations/20260922000000_provider_neutral_billing.sql
